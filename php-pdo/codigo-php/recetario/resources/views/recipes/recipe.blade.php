    ...
    <div class="content">
        <div class="row nomarpad">                        
            ...
            <div class="col-10 nomarpad" style="padding:10px!important">
                <div class="row nomarpad">
                    <div class="col-11 nomarpad" style="text-decoration:none;text-decoration:underline; font-weight:bold;word-break: break-word;overflow: hidden;text-overflow: ellipsis;display: -webkit-box;line-height: 16px; /* fallback */
                                        max-height: 32px; /* fallback */-webkit-line-clamp: 2; /* number of lines to show */-webkit-box-orient: vertical;"><p>{{$recipe->title}}</p> </div>
